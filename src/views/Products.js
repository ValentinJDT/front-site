...
const Products = () => {
            ...
            <div className="card rounded-0" style={{maxWidth: "540px"}}>
                <div className="row g-0">
                    ...
                    <div className="col-md-4">
                        <img src={product.image || coffee} className="img-fluid rounded-0 my-auto product-image"
                             alt="..."/>
                    </div>
                </div>
            </div>
    ...
    const _categories = categories.map(category => (
            <option value={category.idCategorie} key={category.idCategorie}>{category.nom} ({category.numProduits})</option>
        )
    );
