        ...
        <>
            ...
            <>
                ...
                <div className={"mt-5 mx-auto"} style={{width: "70%"}}>
                    ...
                    <textarea className="form-control" id="inputBody" placeholder="Description de la rubrique..."/>

                    <button type="button" className="btn btn-outline-secondary my-4" onClick={handleRubric}>Enregistrer</button>
                </div>
            </>
        </>
